...
import TextWithReadMore from "../readMoreAndLess/ReadMoreAndLess";

export default function GithubRepoCard({ repo, theme, className }) {
  ...
  return (
    <div
      className={"repo-card-div " + className}
      ...
      <Fade bottom duration={2000} distance="40px">
        ...
        >
          ...
          <p className="repo-description" style={{ color: theme.text }}>
            <TextWithReadMore text={repo.description} limit={120} />
            {/* {} */}
          </p>
          <div className="repo-details flex justify-center my-12">
            {/* <p
          ...
          {Array.isArray(repo.gallery) && repo.gallery.length > 0 && (
            <Gallery images={repo.gallery} />
          )}
